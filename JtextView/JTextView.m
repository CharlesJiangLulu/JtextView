...
-(void)addTextViewBeginEvent:(void (^)(JTextView *))begin{
    
    _BeginBlock=begin;
}

-(void)addTextViewEndEvent:(void (^)(JTextView *))End{
    _EndBlock=End;
}
...
-(void)textViewBeginNoti:(NSNotification*)noti{
    ...
    if (_BeginBlock) {
        void(^begin)(JTextView*text)=_BeginBlock;
        begin(self);
    }
}
-(void)textViewEndNoti:(NSNotification*)noti{
    ...
    if (_EndBlock) {
        void(^end)(JTextView*text)=_EndBlock;
        end(self);
    }
}
...
-(void)DidChange:(NSNotification*)noti{
    ...
    if (_eventBlock && self.text.length > self.maxTextLength) {
        ...
        void (^limint)(JTextView*text) =_eventBlock;
